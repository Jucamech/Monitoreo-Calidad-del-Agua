...
//Modo de calibración de un punto=0
//Modo de calibración de dos puntos=1
#define TWO_POINT_CALIBRATION 0

#define READ_TEMP (25) //Temperatura actual del agua ℃, o función del sensor de temperatura
